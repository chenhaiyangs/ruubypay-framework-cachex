package com.ruubypay.cachex.script;

import com.ruubypay.cachex.AbstractScriptParser;
...
public class SpelScriptParser implements AbstractScriptParser {
    ...
    @Override
    public String buildMatchedPrefix(String script) {
         return  getPrefix(script).replaceAll("'","");
    }
}
